...
class NewborncareCheckController extends \yii\web\Controller {
    ...
    public function actionIndex() {
        ...
        $sql = "SELECT * FROM newborn_cid p WHERE p.HOSPCODE = '$hospcode'";
...
,p.CID,p.`NAME` as 'ชื่อ',p.LNAME as 'สกุล',p.SEX
,p.BDATE as 'วันคลอด'
...
WHERE  p.CID = '$cid' ";
        ...
        $sql = "SELECT * FROM newborncare_cid t WHERE t.CID='$cid' ORDER BY  t.BCARE ASC";
