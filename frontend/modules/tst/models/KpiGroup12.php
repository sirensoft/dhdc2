...
class KpiGroup12 extends Model {
...
,(SELECT 'Yes' FROM tst_kpi20 a WHERE a.cid=t.cid ) _20
,(SELECT 'Yes' FROM tst_kpi21 a WHERE a.cid=t.cid ) _21
,(SELECT 'Yes' FROM tst_kpi22 a WHERE a.cid=t.cid ) _22
