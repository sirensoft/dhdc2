...
,(SELECT 'Yes' FROM tst_kpi9 a WHERE a.cid=t.cid ) _9
,(SELECT 'Yes' FROM tst_kpi10 a WHERE a.cid=t.cid ) _10
,(SELECT 'Yes' FROM tst_kpi11 a WHERE a.cid=t.cid ) _11
,(SELECT 'Yes' FROM tst_kpi12 a WHERE a.cid=t.cid ) _12
